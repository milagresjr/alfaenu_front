...
import { useGetConfigReconhecimentoCriminal, useUpdateConfigReconhecimentoCriminal } from "@/features/solicitacao-reconhecimento-registo-criminal/hooks/useAdminReconhecimentoRegistoCriminalQuery"

export default function ConfigReconhecimentoRegistoCriminalForm() {
  const { data: config, isLoading } = useGetConfigReconhecimentoCriminal()
  const updateConfig = useUpdateConfigReconhecimentoCriminal()
      ...
      <Card className="w-full md:w-[95%]">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Configuração - Reconhecimento de Registo Criminal</CardTitle>
          </div>
          <CardDescription>
