...
import { Upload, FileText, AlertCircle, Trash2, Eye, Building2 } from "lucide-react"

interface EnviarReservaHotelFormProps {
  open: boolean
...
export function EnviarReservaHotelForm({
  open,
  onOpenChange,
  onConfirm,
  isLoading,
  clienteNome,
}: EnviarReservaHotelFormProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Enviar documento de reserva de hotel para <strong>{clienteNome}</strong>
          </DialogDescription>
        </DialogHeader>
