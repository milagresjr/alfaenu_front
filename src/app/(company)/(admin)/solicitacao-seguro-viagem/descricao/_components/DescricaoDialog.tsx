...
interface DescricaoDialogProps {
  ...
  descricao?: SolicitacaoSeguroViagemDescricaoType | null
  isLoading?: boolean
}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {descricao
              ? 'Edite a descrição que será exibida no formulário de solicitação de seguro de viagem.'
              : 'Crie uma descrição que será exibida no formulário de solicitação de seguro de viagem.'}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              placeholder="Descreva as informações sobre o seguro de viagem (ex: taxas, documentos necessários, etc.)"
              value={texto}
