...
import { Clock, CheckCircle, XCircle, FileText, Eye, User, File, Mail, Phone, Calendar, MessageSquare, Plane } from "lucide-react"
import { toast } from "react-toastify"

interface DetalhesPrintVooDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  solicitacao: SolicitacaoPrintVooType | null
}
...
export function DetalhesPrintVooDialog({ open, onOpenChange, solicitacao }: DetalhesPrintVooDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          <Section title="Dados da Solicitação" icon={<Plane className="h-4 w-4" />}>
