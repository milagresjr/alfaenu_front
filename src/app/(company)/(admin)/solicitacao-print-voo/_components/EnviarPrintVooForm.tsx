...
import { Upload, FileText, AlertCircle, Trash2, Eye, Plane } from "lucide-react"

interface EnviarPrintVooFormProps {
  open: boolean
...
export function EnviarPrintVooForm({
  open,
  onOpenChange,
  onConfirm,
  isLoading,
  clienteNome,
}: EnviarPrintVooFormProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Enviar documento de print de voo para <strong>{clienteNome}</strong>
          </DialogDescription>
        </DialogHeader>
