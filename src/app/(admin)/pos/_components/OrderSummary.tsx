            ...
            <div className="h-[100px] flex flex-col">
                <div className="flex flex-col px-4 py-2 ">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-gray-700 font-medium text-sm">{totalPorPagar}</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-gray-500 text-sm">Pago</span>
                        <span className="text-gray-700 font-medium text-sm">{totalPago}</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-gray-500 text-sm">Saída</span>
                        <span className="font-medium text-sm dark:text-gray-700">{saida || 0}</span>
                    </div>
                </div>
                <div className="flex justify-between items-center bg-blue-800 py-3 px-4 text-center rounded-b-lg">
                    ...
                    <span className="font-medium text-white text-lg"> {isNaN(saldoTotal) ? "0" : saldoTotal}</span>
                </div>
            </div>
        </div>
    )
